...
const Diamond = () => {
  return (
    <div className="p-4">
      ...
      {/* Offer Banner */}
      <div className="mt-5">
        <img src="https://dkbasakjewellers.com/wp-content/uploads/2022/04/Diamond-Rings-min-compressed.jpg" alt="Offer Banner" className="w-full h-80 rounded-lg shadow-md mt-35"/>
      </div>
