...
const SilverItems = () => {
  ...
  return (
    <div className="p-4">
      ...
      <div className="mt-5">
        <img
          src="https://beliramsilverware.com/wp-content/uploads/2022/10/beliram-banner-4.jpg"
          alt="Offer Banner"
      ...
      <div className="mt-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
            ...
            <button className="mt-2 bg-pink-500 text-white px-4 py-2 rounded-md font-semibold hover:bg-pink-600">
              Buy Now
            </button>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-md">
