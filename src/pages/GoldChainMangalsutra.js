...
const GoldChainMangalsutra = () => {
  return (
    <div className="p-4">
      ...
      <h1 className="text-4xl font-bold mt-16 text-center">Gold Chain/ Mangalsutra</h1>
      <p className='text-3xl font-bold mt-8 text-center'>Explore our exquisite collection of Gold jewellery.</p>

      
      {/* Offer Banner */}
      <div className="mt-5">
        <img src="https://modernjewellers.in/images/mangalsutra_banner.jpg" alt="Offer Banner" className="w-full h-80 rounded-lg shadow-md mt-35"/>
      </div>
