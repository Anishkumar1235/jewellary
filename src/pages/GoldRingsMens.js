...
import girl from '../assets/Girlring5.jpg'
...
import img8 from '../assets/img9.webp'
...
const GoldRingsMens = () => {
  return (
    <div className="p-4">
      ...
      <h1 className="text-4xl font-bold mt-16 text-center">GoldRingsMens/Women</h1>
      <p className='text-3xl font-bold mt-8 text-center'>Explore our exquisite collection of Gold jewellery.</p>

      
      {/* Offer Banner */}
      <div className="mt-5">
        <img src="https://sencowebfiles.s3.ap-south-1.amazonaws.com/contents/banner/rsUdyTRCvwENN0Mc93JLYxqZqgmChkqWRgIkPZZI.jpeg" alt="Offer Banner" className="w-full h-80 rounded-lg shadow-md mt-35"/>
      </div>
      ...
      <p className="text-gray-700">From: ₹<b>899.99</b></p>
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
          <img src={girl} alt="Product 1" className="w-full h-40 object-cover rounded-md mb-4"/>
