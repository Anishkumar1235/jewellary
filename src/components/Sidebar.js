...
//   faBars,
//   faTimes,
//   faCartPlus, // Import the Add to Cart icon
...
//     >
//       <h2 className="text-1xl md:text-2xl font-bold mr-4">E-Commerce</h2>
...
//       <Link
//         to="/cart"
//         className="text-white ml-4 hover:bg-yellow-500 p-2 rounded"
//       >
...
const Sidebar = () => {
  ...
  const handleAddToCart = (productId, productName, img, price) => {
    const newProduct = {
      id: productId,
      name: productName,
      image: img,
    ...
    >
      ...
      <div className="flex items-center space-x-2 flex-1 max-w-xs sm:max-w-xs md:max-w-sm lg:max-w-full">
        <input
          type="text"
          placeholder="Search..."
          className="p-1 border border-gray-300 rounded text-black w-20 sm:w-35 md:w-60"
        />
        <button className="bg-pink-500 text-white px-3 py-1 rounded hover:bg-gray-200">
          Search
        </button>
      ...
      >
        ...
        <div className="relative lg:inline-flex group">
          <button className="flex items-center px-4 py-2 hover:bg-pink-600 rounded lg:inline-flex">
            <FontAwesomeIcon icon={faShoppingCart} className="mr-2" /> Products{" "}
            <FontAwesomeIcon icon={faChevronDown} className="ml-2" />
          </button>
          <div className="absolute right-0 bg-gray-800 text-white flex flex-col lg:mt-1 mt-2 w-40 hidden group-hover:flex">
            <Link
              ...
              className="flex items-center px-4 py-2 hover:bg-pink-600 rounded"
            >
              <FontAwesomeIcon icon={faDiamond} className="mr-2" /> Diamond
            </Link>
            <Link
              to="/products/gold"
              className="flex items-center px-4 py-2 hover:bg-pink-600 rounded"
            >
              <FontAwesomeIcon icon={faRing} className="mr-2" /> Gold
            </Link>
            <Link
              to="/products/silver"
              className="flex items-center px-4 py-2 hover:bg-pink-600 rounded"
            >
              <FontAwesomeIcon icon={faCoins} className="mr-2" /> Silver
            </Link>
          </div>
        </div>
        <div className="relative lg:inline-flex group">
          <button className="flex items-center px-4 py-2 hover:bg-pink-600 rounded lg:inline-flex">
            <FontAwesomeIcon icon={faGem} className="mr-2" /> Categories{" "}
            <FontAwesomeIcon icon={faChevronDown} className="ml-2" />
          </button>
          <div className="absolute right-0 bg-gray-800 text-white flex flex-col lg:mt-1 mt-2 w-64 hidden group-hover:flex">
            <Link
        ...
        <Link
          ...
          className="flex items-center px-4 py-2 hover:bg-pink-600 rounded lg:inline-flex"
        >
          <FontAwesomeIcon icon={faPhone} className="mr-2" /> Contacts
        </Link>
        <Link
          to="/logout"
          className="flex items-center px-4 py-2 hover:bg-pink-600 rounded lg:inline-flex"
