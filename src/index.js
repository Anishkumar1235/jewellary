...
//  <img src={img2} alt="Product 2" className="w-full h-40 object-cover rounded-md mb-4" />
...
// {/* Product 3 */}
// <div className="bg-white p-4 rounded-lg shadow-md hover:bg-pink-200">
//  <img src={img3} alt="Product 3" className="w-full h-40 object-cover rounded-md mb-4" />
...
// {/* Product 4 */}
// <div className="bg-white p-4 rounded-lg shadow-md hover:bg-pink-200">
//  <img src={img4} alt="Product 4" className="w-full h-40 object-cover rounded-md mb-4" />
